...
public class Nave extends BranchGroup{
    ...
    float [] knots = {0f, 0.14f, 0.28f, 0.42f, 0.56f, 0.7f, 0.84f, 1f};
    Texture textura;
    TransformGroup tg;
    BranchGroup bg;
    ...
    Nave(){
        ...
        puntosTrayectoria[3] = new Point3f(10f,15f,5f);
        ...
        puntosTrayectoria[7] = new Point3f(10f,10f,-10f);
        ...
        puntosOrientacion[1].set(new AxisAngle4f(1.0f, 0.0f, 0.0f, (float) Math.toRadians(315)));
        ...
        puntosOrientacion[3].set(new AxisAngle4f(1.0f, 0.0f, 0.0f, (float) Math.toRadians(45)));
        puntosOrientacion[4] = new Quat4f();
        puntosOrientacion[4].set(new AxisAngle4f(0.0f, 1.0f, 0.0f, (float) Math.toRadians(270)));
        puntosOrientacion[5] = new Quat4f();
        puntosOrientacion[5].set(new AxisAngle4f(0.0f, 1.0f, 0.0f, (float) Math.toRadians(180)));
